...
public final class SettingsController {
    ...
    @FXML private TextField ffmpegField, ffprobeField, moviesField, seriesField, moviesOutputField, seriesOutputField;
    ...
    private void load() { AppSettings s=context.settings().get(); ffmpegField.setText(s.ffmpegPath); ffprobeField.setText(s.ffprobePath); moviesField.setText(s.moviesFolder); seriesField.setText(s.seriesFolder); moviesOutputField.setText(s.moviesOutputFolder); seriesOutputField.setText(s.seriesOutputFolder); }
